  ...
  return (
    ...
    >
      <div className="max-w-7xl px-4 md:px-6 lg:px-8  mx-auto flex items-center justify-between py-4">
          ...
          {navLinks.map((link) => (
            <button
              ...
              className={`relative text-sm font-medium transition-colors duration-200 cursor-pointer group ${
                isActive(link.href)
                  ? "text-orange-800"
                  : "text-neutral-800 hover:text-orange-800"
              }`}
            >
              {link.label}
              {/* Active indicator */}
        ...
        {/* Hamburger */}
        <button
          className="md:hidden p-2 rounded-xl text-neutral-800 hover:bg-orange-50 transition cursor-pointer"
              ...
              <button
                ...
                className={`w-full text-left px-4 py-3 rounded-2xl text-sm font-medium transition cursor-pointer ${
                  isActive(link.href)
                    ...
                    : "text-neutral-800 hover:bg-orange-50/60 hover:text-orange-800"
                }`}
              >
                {link.label}
              </button>
