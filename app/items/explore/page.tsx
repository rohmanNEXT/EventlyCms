                          ...
                          <div key={country} className="flex flex-col gap-1">
                            ...
                            >
                              ...
                              {countryLocations.length > 0 && (
                                <span
                                  className={`text-[10px] px-1.5 py-0.5 rounded-md font-semibold ${isActiveCountry ? "bg-white/20 text-white" : "bg-orange-100 text-orange-800"}`}
                                >
                                  ...
                                  return (
                                    <button
                                      ...
                                      className={`text-left px-3 py-1.5 rounded-lg text-[13px] font-medium transition ${isActiveLoc
                                        ...
                                        : "text-neutral-700 hover:text-orange-800 hover:bg-orange-50/50"
                                        }`}
                                    >
                                      {loc}
                                    </button>
          ...
          <div className="flex-1 flex flex-col">
            ...
            {!loading &&
              ...
              currentItems.length === 0 && (
                <div className="w-full flex-1 min-h-[350px] flex flex-col items-center justify-center text-center py-20 bg-white rounded-3xl border border-orange-400/70">
                  ...
                  <p className="text-neutral-700 mt-2 text-sm max-w-sm mx-auto">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex flex-col flex-1 p-4 gap-2">
                        ...
                        <div className="h-9 text-xs text-neutral-700 overflow-hidden line-clamp-2 leading-relaxed mt-1 [&_a]:text-orange-800 [&_strong]:font-semibold [&_ul]:list-disc [&_ul]:pl-4 [&_ol]:list-decimal [&_ol]:pl-4 [&_li]:ml-2 [&_p]:inline [&_p]:mr-1">
                          {event.description ? (
                        ...
                        <button
                          ...
                          className="mt-auto pt-3 flex items-center gap-1 text-xs font-semibold text-orange-800 hover:text-orange-800 transition group/btn cursor-pointer"
                        >
                          View Details
                          <LuArrowRight
                            size={13}
            ...
            {loading ? (
              ...
              <div className="mt-auto w-full">
                ...
                {filtered.length > 0 && (
                  <p className="text-center text-[11px] md:text-xs text-neutral-600 mt-12 font-medium">
