...
import { LuArrowLeft, LuMapPin, LuTag, LuArrowRight, LuBadgeCheck } from "react-icons/lu";
import type { ContentfulLink } from "../../../../lib/type";
    ...
    <div className="w-full flex-1 pb-10">
      {loading ? (
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <button
            onClick={() => router.back()}
            className="flex items-center gap-1.5 text-sm text-neutral-700 hover:text-orange-800 transition mb-6 cursor-pointer group w-fit"
          >
          ...
          <div className="flex flex-col items-center text-center">
            ...
            {/* Title */}
            <h1 className="text-3xl font-semibold text-neutral-800 leading-tight mb-3">
              {event.title}
            </h1>
              ...
              <div className="flex items-center gap-3 bg-[#FFFAF7] px-4 py-2 rounded-full border border-orange-400/80 shadow-sm">
                ...
                <div className="text-left pr-2">
                  <p className="flex items-center gap-1.5 text-[13px] font-semibold text-neutral-800 leading-none">
                    {event.author}
                    <LuBadgeCheck size={14} className="text-blue-500 fill-blue-50" />
                  </p>
                  <p className="text-[10px] text-neutral-700 mt-0.5 uppercase tracking-wide">Event Publisher</p>
                </div>
              </div>
            ...
            {/* Description */}
            {event.description && (
              <article className="w-full flex flex-col items-center text-center text-sm md:text-base text-neutral-700 leading-relaxed space-y-4 [&_a]:text-orange-800 [&_a]:hover:underline [&_strong]:font-semibold [&_ul]:list-disc [&_ul]:pl-5 [&_ul]:mb-4 [&_ul]:inline-block [&_ul]:text-left [&_ol]:list-decimal [&_ol]:pl-5 [&_ol]:mb-4 [&_ol]:inline-block [&_ol]:text-left [&_h1]:text-2xl [&_h1]:font-semibold [&_h2]:text-xl [&_h2]:font-semibold [&_h3]:text-lg [&_h3]:font-semibold [&_li]:mb-1 [&_p]:mb-4 mb-10">
                ...
                <div className="overflow-hidden rounded-2xl bg-[#FFFAF7] border border-orange-400/80 shadow-sm">
                  <div className="flex flex-col items-center text-center gap-3 p-6">
                    ...
                    <div className="flex flex-col items-center">
                      <p className="text-[10px] font-semibold text-neutral-700 uppercase tracking-widest mb-1">Event Location</p>
