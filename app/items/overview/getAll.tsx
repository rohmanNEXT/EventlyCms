      ...
      <div className="w-full">
        <AnimatePresence mode="wait">
          {loading ? (
                  ...
                  return (
                    ...
                    >
                      <div className="relative h-56 w-full overflow-hidden rounded-t-2xl group/slider">
                        {images.length > 0 ? (
                          ...
                          <div className="w-full h-full flex items-center justify-center bg-neutral-100">
                             <span className="text-neutral-600 text-4xl">E</span>
                          </div>
                        )}
                      ...
                      <div className="flex flex-col flex-1 p-4 gap-2">
                        ...
                        <div className="h-9 text-xs text-neutral-700 overflow-hidden line-clamp-2 leading-relaxed mt-1">
                          {event.description ? (
            ...
            {filtered.length > 0 && (
              <p className="text-center text-[11px] md:text-xs text-neutral-600 font-medium mt-12">
