...
export default function SerpPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center py-40 justify-center">
      <h1 className="text-2xl font-medium mb-8">Cari Event</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 w-11/12 max-w-6xl">
        {currentEvents.map((event) => (
          ...
          >
            <h2 className="font-semibold text-lg mb-2 h-16">
            ...
            <button
              ...
              className="mt-4 inline-flex items-center justify-center gap-2 text-white bg-orange-900 hover:bg-orange-700 rounded-full px-4 py-2 font-medium transition cursor-pointer"
            >
